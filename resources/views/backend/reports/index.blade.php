...
@section('content')
            ...
            <div class="card">
                <div class="card-body p-24">
                    <div class="d-flex gap-3 align-items-center">
                        <span class="text-md fw-medium">Report type:</span>
                        <button type="button" class="btn btn-outline-neutral-900 radius-4 px-20 py-8">Daily Production</button>
                        <button type="button" class="btn btn-outline-neutral-900 radius-4 px-20 py-8">Weekly/ Monthly Summary</button>
                        <button type="button" class="btn btn-outline-neutral-900 radius-4 px-20 py-8">Error Logs</button>
                        <button type="button" class="btn btn-outline-neutral-900 radius-4 px-20 py-8">Custom Report</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-20">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0 fw-bold text-lg">Export Reports</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('reports.export') }}" method="POST">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label mb-16">Format</label>
                            ...
                            <div class="col-md-4">
                                <label class="form-label mb-16">Data to Include</label>
                            ...
                            {{-- Scheduling --}}
                            <div class="col-md-4">
                                <label class="form-label mb-16">Scheduling</label>
                            ...
                            <div class="col-12 mt-40">
                                <button type="submit" class="btn bg-dark text-light text-md px-16 py-4 radius-4">
                                    <i class="ri-download-line icon text-xl line-height-1 me-2"></i>
                                    Export Now
                                </button>
                            </div>
                        </div>
            ...
            <div class="card h-100">
                <div class="card-header">
                    <div class="d-flex align-items-center flex-wrap gap-2 justify-content-between">
                        <h6 class="mb-2 fw-bold text-lg mb-0">Recent Reports</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="javascript:void(0)" class="w-32-px h-32-px d-inline-flex align-items-center justify-content-center">
